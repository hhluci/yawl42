...
public class LogPredicateStyledDocument extends DefaultStyledDocument
    ...
    private static final List<String> DECOMPOSITION_PARAMETERS =
            Arrays.asList("name", "spec:name", "inputs", "outputs", "doco");

    private static final List<String> SPECIFICATION_PARAMETERS =
            Arrays.asList("name", "version", "key");

    private static final List<String> TASK_PARAMETERS =
            Arrays.asList("id", "name", "doco", "decomposition:name");

    private static final List<String> ITEM_PARAMETERS =
    ...
    private static final List<String> TIME_PARAMETERS =
    ...
    private void highlight(final List<Block> blocks) {
